...
class DonationsController extends VoyagerBaseController
{
    ...
    public function exportAll(){
        // return Excel::download(new DonationExport, 'donations-' . time() . '.xlsx');
        $month = 0;
        $year = 0;
        return (new DonationExport)->forPeriod($month, $year)->download('donations-'. time() . '.xlsx');
    }
