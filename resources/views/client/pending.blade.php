...
<section style="background-image: url({{ asset('img/bg-thank-you.jpg') }});background-size:center;height:1000px;">
    <div class="uk-container-expand">
        ...
        <div class="uk-container uk-container-small uk-padding" style="background:rgba(255,255,255, 0.85);border-radius:10px;">
            <h1 class="uk-text-center uk-padding title-modal uk-padding-remove-bottom">Ayoo!</h1>
            <h2 class="uk-text-center uk-visible@s" style="font-size: 1.5rem;"> Selangkah lagi untuk dapat berbagi kebaikan dari Anda, yuk selesaikan donasimu.</h2>
            <h4 class="uk-text-center uk-padding-bottom uk-hidden@s" style="font-size: 1rem;">Selangkah lagi untuk dapat berbagi kebaikan dari Anda, yuk selesaikan donasimu.</h4>
            <br>
